...
>
> 検証日: 2026-05-29 / ホスト: macOS (`KazukinoMacBook-Pro.local`) / Claude Desktop Cowork
...
MP_SCRIPT_MARKER form=bashbrace reached=yes argv0=[/var/folders/ph/.../T/claude-hostloop-plugins/66135c2b7384a210/hooks/marker.sh] ROOT_ENV=[/var/folders/ph/.../66135c2b7384a210] DATA_ENV=[/var/folders/ph/.../a8730419d9c8ad74/plugins/data/cowork-mp-script-probe-inline] HOST=[KazukinoMacBook-Pro.local]
MP_SCRIPT_MARKER form=topbare  reached=yes argv0=[/var/folders/ph/.../T/claude-hostloop-plugins/66135c2b7384a210/hooks/marker.sh] ROOT_ENV=[/var/folders/ph/.../66135c2b7384a210] DATA_ENV=[/var/folders/ph/.../a8730419d9c8ad74/plugins/data/cowork-mp-script-probe-inline] HOST=[KazukinoMacBook-Pro.local]
```
...
| marker 内 `HOST` | `$(hostname)` | `KazukinoMacBook-Pro.local`（macOS 本体名） | `LAPTOP-BKGB6100`（Windows 名 / WSL2） |
...
```
┌──────────────────────────────────────────────────────────┐
│ ① macOS ホスト (KazukinoMacBook-Pro.local)               │
